                    ...
                    <div data-panel="spacePropsPanel" class="panel space-props-panel-container">
                        ...
                        <div data-panel="lifecyclePanel" class="lifecycle-panel" id="lifecyclePanel">
                            ...
                            <div class="lifecycle-content">
                                ...
                                <div data-section="cmdConsole" class="lifecycle-console-container">
                                    <div class="console-header">
                                        ...
                                        <div class="console-toggles">
                                            ...
                                            <button class="console-toggle" data-toggle="oneShot" title="OneShot">OneShot</button>
                                            <button class="console-toggle" data-toggle="spaceProps" title="SpaceProps">SpaceProps</button>
                                            <button class="console-clear-button" id="clearConsoleBtn2" title="Clear Console" data-panel="lifecyclePanelClearConsoleBtn">🗑️</button>
                                        </div>
                                    </div>
                                    <div class="lifecycle-console" id="lifecycleConsole"></div>
                                    <input class="command-console-input" id="commandConsoleInput" placeholder="> cmd" data-input="lifecyclePanelCommandConsoleInput">
                                </div>
                            </div>
                        </div>
                    </div>
