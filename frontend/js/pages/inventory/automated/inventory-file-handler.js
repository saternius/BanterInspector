 ...
 */
export default class InventoryFileHandler {
    ...
    async handleFileUpload(event) {
        ...
        try {
            if (fileExt === 'js') {
                ...
                this.inventory.ui.notify('Please upload a .js, .json, or image file (.png, .jpg, .jpeg, .bmp, .gif)');
            }
        } catch (error) {
            console.error('File upload error:', error);
            this.inventory.ui.notify(`Error uploading file: ${error.message}`);
        }
